...
return {
	ACTIONFAIL =
	{
		SHAVE =
		{
			AWAKEBEEFALO = "I probably shouldn't try that while he's awake.",
			GENERIC = "I can't shave that!",
			NOBITS = "There isn't even any stubble left!",
		},
		STORE =
		{
			GENERIC = "It's too full...",
	...
	ANNOUNCE_DAMP = "I should have hung up a Teruteru bozu",
	ANNOUNCE_WET = "Waa, my clothes are going to become see-through!",
	ANNOUNCE_WETTER = "Water, can you go away please?",
	...
	DESCRIBE =
	{
		...
		GLOMMERWINGS = "It was cute...",
		GLOMMERFUEL = "This goop smells bad.",
		BELL = "Dingalingaling.",
		STATUEGLOMMER = 
		{	
		...
		MOLEHAT = "This should stop my hair from getting wet.",

		EEL = "This will make a delicious meal.",
		EEL_COOKED = "Smells great!",
		UNAGI = "This would go nicely with some Sake!",
		...
		{
		CALM = "All is well.",
		WARN = "It's getting magical around here.",
		...
		CAVE_BANANA_TREE = "It'll give me bananas!.",
		...
		BIRDCAGE =
		{
			...
			OCCUPIED = "That's my cute little bird!",
		...
		BLOWDART_FIRE = "This seems unsafe.",
		...
		CATCOON = "It's playful cute little thing.",
		CATCOONDEN = 
		{
