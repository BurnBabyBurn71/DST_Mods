...
local assets = {
        ...
        Asset( "ANIM", "anim/gumi.zip" ),
        Asset( "ANIM", "anim/ghost_gumi_build.zip" ),
}
local prefabs = {}
...
local common_postinit = function(inst) 
	-- Minimap icon
	inst.MiniMapEntity:SetIcon( "gumi.tex" )
end
...
local master_postinit = function(inst)
	...
	-- Sanity multiplier
	inst.components.sanity.rate_modifier = 1.25
...
return MakePlayerCharacter("gumi", prefabs, assets, common_postinit, master_postinit, start_inv)
